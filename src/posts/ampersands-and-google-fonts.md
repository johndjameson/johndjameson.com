...
![Baskerville’s ampersand compared with Baskerville Italic’s ampersand](/images/ampersands-baskerville.svg)
...
@font-face {
  ...
  font-style: italic;
  font-weight: 400;
  src: local('Font Name'), local('FontName-Italic'),
    url(http://themes.googleusercontent.com/licensed/font?kit=V_k5El2vkhx93NlGwmIB5Y3CqX6P7Jx8H90cFJ_LRto)
      format('woff2'), url(http://themes.googleusercontent.com/licensed/font?kit=p0-i_LrFh6jEfrY2wE1ZTo3CqX6P7Jx8H90cFJ_LRto)
      format('woff');
}
```

Due to different implentations of `@font-face` across older browsers, Google delivers unique versions of this file depending on what browser makes the request. The `@font-face` syntax has been standardized in recent years, making user agent detection less and less necesary as time goes on. If you’re willing to drop Google’s user agent detection _in favor of making fewer HTTP requests_, then **we can paste this CSS directly into our style sheet.**
