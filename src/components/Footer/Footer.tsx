...
export default function Footer() {
  return (
    <footer className={clsx("px-container-w bg-neutral-950 py-12", "md:py-16")}>
      <div className="grid gap-x-4 border-2 border-neutral-50 bg-neutral-50 bg-clip-content p-1 text-neutral-950 md:grid-cols-6">
        <div className="flex flex-col px-4 py-10 md:col-span-4 md:col-start-2 md:px-0">
          ...
          <p className="mb-12 border-2 border-black p-6 text-center text-sm sm:text-base md:text-lg">
