...
<%= codepen({ pen: '24f0cb69d20658c4b14f6fef8e32ce59', height: 540 }) %>
...
<%= codepen({ pen: 'c41229e9197ff46d987dceffb4f36b38', height: 470 }) %>

The more text there is, the more reliable the resulting number becomes.

<%= codepen({ pen: 'a6c07f62eb3d33741effa552b22abd84', height: 340 }) %>
