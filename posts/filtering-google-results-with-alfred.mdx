...
layout: article
date: '2014-08-20'
description: 'Google offers powerful filters for search results that can help you find exactly what you’re looking for — it just isn’t quick or easy to do. By using Alfred, you can configure these searches once and reuse them whenever you want.'
---
